...
```text
# requirements.txt
csv-inspector @ git+https://github.com/deluispablo/data-agent-toolkit@csv-inspector-v0.6.0#subdirectory=agents/csv_inspector
# ...or with the cloud (Gemini) backend and environment loading:
csv-inspector[cloud] @ git+https://github.com/deluispablo/data-agent-toolkit@csv-inspector-v0.6.0#subdirectory=agents/csv_inspector
```
